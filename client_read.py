...
def read_value():
    global mn_path
    char_proxy = bus.get_object(bluetooth_constants.BLUEZ_SERVICE_NAME, mn_path)
    ...
    try:
        ...
        print("Failed to execute ReadValue({})")
        print(e.get_dbus_name())
        print(e.get_dbus_message())
        return bluetooth_constants.RESULT_EXCEPTION
    else:
        print("value: ", bluetooth_utils.dbus_to_python(value))
